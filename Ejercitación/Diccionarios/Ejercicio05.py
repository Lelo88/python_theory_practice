...
# cada asignatura en el formato <asignatura> tiene <créditos> créditos, donde <asignatura> es 
...
asignaturas = {'Matematicas': 6, 'Fisica': 4, 'Química': 5}

for materia,nota in asignaturas.items():
    print(materia, nota)
